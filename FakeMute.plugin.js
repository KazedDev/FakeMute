...
module.exports = class FakeMuteByKazed {
    ...
    tryDOMMethod() {
        ...
        try {
            ...
            console.log('FakeMute by Kazed: Bouton injecté dans voiceButtonsContainer');
        } catch (e) {
            console.error('FakeMute by Kazed: Impossible d\'injecter le bouton', e);
        }
    }
    ...
    enableFakeMute() {
        const originalSend = WebSocket.prototype.fakeMuteKazedOriginal;
